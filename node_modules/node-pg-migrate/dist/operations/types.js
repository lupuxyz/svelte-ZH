...
const undoRenameTypeAttribute = (typeName, attributeName, newAttributeName) => renameTypeAttribute(typeName, newAttributeName, attributeName);
...
const undoRenameTypeValue = (typeName, value, newValue) => renameTypeValue(typeName, newValue, value);
